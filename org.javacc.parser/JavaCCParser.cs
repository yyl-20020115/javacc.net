...
public class JavaCCParser : JavaCCParserInternals //, JavaCCParserConstants
{
		...
		public void AccessModifier(NormalProduction np)
	{
		...
		public void ResultType(ArrayList v)
	{
		Token token = getToken(1);
		switch ((this.m_jj_ntk != -1) ? this.m_jj_ntk : jj_ntk())
		{
		...
		public void FormalParameters(ArrayList v)
	{
		jj_consume_token(91);
		Token token = getToken(1);
		int num = ((this.m_jj_ntk != -1) ? this.m_jj_ntk : jj_ntk());
		...
		public void expansion_unit(Container c)
	{
		...
		case 76:
		{
			...
			ArrayList vector4 = new ArrayList();
			ArrayList v = null;
			ArrayList vector5 = new ArrayList();
	...
	private bool notTailOfExpansionUnit()
	{
		...
		public void Expression(ArrayList v)
	{
		Token token = getToken(1);
	...
	private bool jj_2_3(int P_0)
	{
		...
		public void Arguments(ArrayList v)
	{
		jj_consume_token(91);
		Token token = getToken(1);
		switch ((this.m_jj_ntk != -1) ? this.m_jj_ntk : jj_ntk())
		...
		public void TypeDeclaration()
	{
		...
		case 139:
		{
			...
			case 35:
			case 55:
				ClassOrInterfaceDeclaration(i, new ArrayList());
				break;
			case 42:
				EnumDeclaration(i);
				break;
		...
		public void EnumConstant()
	{
		...
		if (((this.m_jj_ntk != -1) ? this.m_jj_ntk : jj_ntk()) == 93)
		{
			ClassOrInterfaceBody(b: false, new ArrayList());
		}
		else
		{
			jj_la1[65] = jj_gen;
		...
		public void BlockStatement()
	{
		...
		case 35:
		case 55:
			ClassOrInterfaceDeclaration(0, new ArrayList());
			return;
		}
		jj_la1[143] = jj_gen;
		jj_consume_token(-1);
